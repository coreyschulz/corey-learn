...
## Setup Data:
trainingInputs, trainingLabels, numFeatures = read_libsvm('data/data_semeion/hand_data_train')
testInputs, testLabels, _ = read_libsvm('data/data_semeion/hand_data_test', numFeatures)
