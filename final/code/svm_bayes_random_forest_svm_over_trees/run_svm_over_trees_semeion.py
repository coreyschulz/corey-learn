    ...
    for rate in initLearningRates:
        for regularization in regularizations:
            ...
            for i in range(len(allFoldInputArrays)):
                ...
                tempsvmovertrees = svmOverTrees(numFeatures, 2, rate, regularization)
...
tester = svmOverTrees(numFeatures, 2, .001, 10)
tester.train(trainingInputsArr, trainingLabels)
print("training accuracy: ")
print(tester.evaluate(trainingInputsArr, trainingLabels))
print("test accuracy: ")
